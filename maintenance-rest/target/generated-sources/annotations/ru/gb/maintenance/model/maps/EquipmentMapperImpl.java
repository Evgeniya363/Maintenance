...
public class EquipmentMapperImpl implements EquipmentMapper {
    ...
    @Override
    public List<EquipmentDto> toDtoList(List<Equipment> listT) {
        if ( listT == null ) {
            return null;
        }
