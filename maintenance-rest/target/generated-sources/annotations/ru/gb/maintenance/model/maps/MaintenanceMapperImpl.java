...
import ru.gb.maintenance.services.ContractorServiceImpl;
...
public class MaintenanceMapperImpl implements MaintenanceMapper {
    ...
    @Override
    public List<MaintenanceDto> toDtoList(List<Maintenance> listT) {
        if ( listT == null ) {
            return null;
        }
    ...
    public Maintenance toEntity(MaintenanceDto dto) {
        ...
        maintenance.setContractor( contractorServiceImpl.getObjectById( dto.getContractorId() ) );
    ...
    private Long entityContractorId(Maintenance maintenance) {
        Contractor contractor = maintenance.getContractor();
        if ( contractor == null ) {
            return null;
        }
