...
//        EquipmentRepository equipmentRepository = ctx.getBean(EquipmentRepository.class);
        ...
        for (Equipment e : equipmentList) {
            ...
            maintenance.setContractor(employeeRepository.getById(employee1.getId() + ThreadLocalRandom.current().nextLong(0, 2)));
            maintenance.setType(
            ...
            maintenance.setEquipment(e);
            maintenance.setContractor(employeeRepository.getById(employee1.getId() + ThreadLocalRandom.current().nextLong(1, 3)));
            maintenance.setType(
                    ThreadLocalRandom.current().nextInt(0, 2) == 0 ?
                            Type.PLANNED :
                            Type.UNSCHEDULED
